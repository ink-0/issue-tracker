...
VALUES ('이슈제목1', '이슈내용1', 'sanhee', 'OPEN'),
       ('이슈제목2', '이슈내용2', 'sanhee', 'OPEN');

INSERT INTO `pyrodb`.`issue`(title, content, writerId, statusId, milestoneId)
VALUES ('이슈제목3-마일스톤1', '이슈내용1', 'sanhee', 'OPEN', 1),
       ('이슈제목4-마일스톤1', '이슈내용2', 'sanhee', 'OPEN', 1);

INSERT INTO `pyrodb`.`comment`(content, dateTime, writerId, issueId)
VALUES ('아슈 아이디1의 댓글 내용1', NOW(), 'sanhee', 1),
       ('아슈 아이디1의 댓글 내용2', NOW(), 'pyro', 1),
       ('아슈 아이디1의 댓글 내용3', NOW(), 'neo', 1),
       ('아슈 아이디1의 댓글 내용4', NOW(), 'sanhee', 1),
